                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
                            <div class="header_right_area">
                                <ul>
                                    <li>
                                        <a class="account" href="#">会员中心</a>
                                    </li>
                                    <li>
                                        <a class="wishlist" href="#">消息</a>
                                    </li>
                                    <!-- <li>
                        ...
                        <div class="col-md-9">
                            <div class="header_all search_box_area">
                                <form class="new_search" role="search" method="get" action="#">
                                    <input id="mix_search" class="search-field" placeholder="请输入" value="" name="s" title="Search for:" type="search">
                                    ...
                                    <div class="col-md-9 pl">
                                        <div class="menu_area">
                                            <div class="menu">
                                                <nav>
                                                    <ul>
                                                        <li><a href="./list-view.html">账号角色</a></li>
                                                        <li><a href="./about-us.html">装备外观</a></li>
                                                        <li><a href="./contact-us.html">物品拍卖</a></li>
                                                        <li><a href="./cart.html">逛店铺</a></li>
                                                        <li><a href="./my.account.html">骗子墙</a></li>
                                                        <!-- <li><a href="./simple-product.html">骗子墙</a></li> -->
            ...
            <div class="container">
                <div class="row">
                    <div class="social_design on_right">
                        <ul>
                            <li>
                                <a class="ba" target="_blank" href="#facebook">
                                    <span>
                                        <i>
                                            <img width="42" height="42" src=".//img/martial-art/bd.png">
                                                <span style="font-size: 20px;    font-family:Open Sans;font-size: 18px;font-style: normal;font-weight: 400;">
                                                    霸刀
                                                </span>
                                            <//img>
                                        </i>
                                        <!-- <span class="social-text">霸刀</span> -->
                                    </span>
                                </a>
                            </li>
                            <li>
                                <a class="ge" target="_blank" href="#twitter.com">
                                    <span>
                                        <i>
                                            <img width="42" height="30" src=".//img/martial-art/cj.png">
                                                <span style="font-size: 20px;    font-family:Open Sans;font-size: 18px;font-style: normal;font-weight: 400;">
                                                    长歌
                                                </span>
                                            <//img>
                                        </i>
                                        <!-- <span class="social-text">长歌</span> -->
                                    </span>
                                </a>
                            </li>
                            <li>
                                <a class="dun" target="_blank" href="#google-plus">
                                    <span>
                                        <i>
                                            <img width="42" height="30" src=".//img/martial-art/dun.png">
                                                <span style="font-size: 20px;    font-family:Open Sans;font-size: 18px;font-style: normal;font-weight: 400;">
                                                    苍云
                                                </span>
                                            <//img>
                                        </i>
                                        <!-- <span class="social-text">苍云</span> -->
                                    </span>
                                </a>
                            </li>
                            <li>
                                <a class="gai" target="_blank" href="#youtube">
                                    <span>
                                        <i>
                                            <img width="42" height="30" src=".//img/martial-art/gb.png">
                                                <span style="font-size: 20px;    font-family:Open Sans;font-size: 18px;font-style: normal;font-weight: 400;">
                                                    丐帮
                                                </span>
                                            <//img>
                                        </i>
                                        <!-- <span class="social-text">丐帮</span> -->
                                    </span>
                                </a>
                            </li>
                            <li>
                                <a class="mie" target="_blank" href="#pinterest">
                                    <span>
                                        <i>
                                            <img width="42" height="30" src=".//img/martial-art/cy.png">
                                                <span style="font-size: 20px;    font-family:Open Sans;font-size: 18px;font-style: normal;font-weight: 400;">
                                                    纯阳
                                                </span>
                                            <//img>
                                        </i>
                                        <!-- <span class="social-text">纯阳</span> -->
                                    </span>
                                </a>
                            </li>
                            <li>
                                <a class="ji" target="_blank" href="mailto:lionthemes88@gmail.com">
                                    <span>
                                        <i>
                                            <img width="42" height="30" src=".//img/martial-art/cj.png">
                                            <span style="font-size: 20px;    font-family:Open Sans;font-size: 18px;font-style: normal;font-weight: 400;">
                                        ...
                                        <!-- <span class="social-text">藏剑</span> -->
                                    </span>
                                </a>
                            </li>
                            <li>
                                <a class="tu" target="_blank" href="mailto:lionthemes88@gmail.com">
                                    <span>
                                        <i>
                                            <img width="42" height="30" src=".//img/martial-art/sl.png">
                                                <span style="font-size: 20px;    font-family:Open Sans;font-size: 18px;font-style: normal;font-weight: 400;">
                                                    少林
                                                </span>
                                            <//img>
                                        </i>
                                        <!-- <span class="social-text">少林</span> -->
                                    </span>
                                </a>
                            </li>
                            <li>
                                <a class="du" target="_blank" href="mailto:lionthemes88@gmail.com">
                                    <span>
                                        <i>
                                            <img width="42" height="30" src=".//img/martial-art/wd.png">
                                                <span style="font-size: 20px;    font-family:Open Sans;font-size: 18px;font-style: normal;font-weight: 400;">
                                                    五毒
                                                </span>
                                            <//img>
                                        </i>
                                        <!-- <span class="social-text">五毒</span> -->
                                    </span>
                                </a>
                            </li>
                            <li>
                                <a class="ce" target="_blank" href="mailto:lionthemes88@gmail.com">
                                    <span>
                                        <i>
                                            <img width="42" height="30" src=".//img/martial-art/tc.png">
                                                <span style="font-size: 20px;    font-family:Open Sans;font-size: 18px;font-style: normal;font-weight: 400;">
                                                    天策
                                                </span>
                                            <//img>
                                        </i>
                                        <!-- <span class="social-text">天策</span> -->
                                    </span>
                                </a>
                            </li>
                            <li>
                                <a class="bao" target="_blank" href="mailto:lionthemes88@gmail.com">
                                    <span>
                                        <i>
                                            <img width="42" height="30" src=".//img/martial-art/tm.png">
                                                <span style="font-size: 20px;    font-family:Open Sans;font-size: 18px;font-style: normal;font-weight: 400;">
                                                    唐门
                                                </span>
                                            <//img>
                                        </i>
                                        <!-- <span class="social-text">唐门</span> -->
                                    </span>
                                </a>
                            </li>
                            <li>
                                <a class="xiu" target="_blank" href="mailto:lionthemes88@gmail.com">
                                    <span>
                                        <i>
                                            <img width="42" height="30" src=".//img/martial-art/qx.png">
                                                <span style="font-size: 20px;    font-family:Open Sans;font-size: 18px;font-style: normal;font-weight: 400;">
                                                    七秀
                                                </span>
                                            <//img>
                                        </i>
                                        <!-- <span class="social-text">七秀</span> -->
                                    </span>
                                </a>
                            </li>
                            <li>
                                <a class="miao" target="_blank" href="mailto:lionthemes88@gmail.com">
                                    <span>
                                        <i>
                                            <img width="42" height="30" src=".//img/martial-art/mj.jpg">
                                                <span style="font-size: 20px;    font-family:Open Sans;font-size: 18px;font-style: normal;font-weight: 400;">
                                                    明教
                                                </span>
                                            <//img>
                                        </i>
                                        <!-- <span class="social-text">明教</span> -->
                                    </span>
                                </a>
                            </li>
                            <li>
                                <a class="hua" target="_blank" href="mailto:lionthemes88@gmail.com">
                                    <span>
                                        <i>
                                            <img width="42" height="30" src=".//img/martial-art/wh.jpg">
                                                <span style="font-size: 20px;    font-family:Open Sans;font-size: 18px;font-style: normal;font-weight: 400;">
                                                    万花
                                                </span>
                                            <//img>
                                        </i>
                                        <!-- <span class="social-text">万花</span> -->
                                    </span>
                                </a>
                            </li>
                        </ul>
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12 text-right">
                        <div class="my-tabs">
                            ...
                            <ul class="favtabs" role="tablist">
                                <li role="presentation" class="active"><a href="#home" aria-controls="home" role="tab" data-toggle="tab">成男</a></li>
                                <li role="presentation"><a href="#profile" aria-controls="profile" role="tab" data-toggle="tab">成女</a></li>
                                <li role="presentation"><a href="#messages" aria-controls="messages" role="tab" data-toggle="tab">正太</a></li>
                                <li role="presentation"><a href="#messages" aria-controls="messages" role="tab" data-toggle="tab">萝莉</a></li>
                            </ul>
                            <!-- Tab panes -->
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12 text-right">
                        <div class="my-tabs">
                            <!-- Nav tabs -->
                            <ul class="favtabs" role="tablist">
                                <li role="presentation" class="active"><a href="#elec" aria-controls="elec" role="tab" data-toggle="tab">成男</a></li>
                                <li role="presentation"><a href="#acc" aria-controls="acc" role="tab" data-toggle="tab">成女</a></li>
                                <li role="presentation"><a href="#head" aria-controls="head" role="tab" data-toggle="tab">正太</a></li>
                                <li role="presentation"><a href="#head" aria-controls="head" role="tab" data-toggle="tab">萝莉</a></li>
                            </ul>
                            <!-- Tab panes -->
                            <div class="tab-content">
