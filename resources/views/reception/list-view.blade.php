                                            ...
                                            <div class="product_content">
                                                <div class="usal_pro">
                                                    <div class="product_name_2">
                                                        <h2>
                                                            <a href="./simple-product.html">Accumsan eli</a>
                                                        </h2>
                                                    </div>
                                        ...
                                        <div class="all-pros  all-pros-4 all-pros-latest">
                                            ...
                                            <div class="product_content">
                                                <div class="usal_pro">
                                                    ...
                                                    <div class="price_box price_box_cpq">
                                    ...
                                    <div class="col-md-4 col-sm-4">
                                        <div class="all-pros all-pros-3 all-pros-latest">
                                            <div class="sinle_pic">
                                                ...
                                                <img class="secondary-/img" src="/img/product-pic/product_pic_11.jpg" alt="" />
                                                </a>
                                            </div>
                                            <div class="product-action" data-toggle="modal" data-target="#myModal">
                                                <button type="button" class="btn btn-info btn-lg quickview" data-toggle="tooltip" title="Quickview">Quick View</button>   
